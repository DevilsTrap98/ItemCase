...
contextBridge.exposeInMainWorld('api', {
  ...
  resubmitCorrection: (payload) => ipcRenderer.invoke('catalog:resubmitCorrection', payload),
  getMyChangeRequests: () => ipcRenderer.invoke('catalog:myChangeRequests'),
  ...
  getMyShowcaseProfile: () => ipcRenderer.invoke('showcase:getMyProfile'),
  saveShowcaseProfile: (payload) => ipcRenderer.invoke('showcase:saveProfile', payload),
  setShowcaseOrder: (itemIds) => ipcRenderer.invoke('showcase:setOrder', itemIds),
  ...
  backupSaveSettings: (payload) => ipcRenderer.invoke('backup:saveSettings', payload),
  backupCreateNow: () => ipcRenderer.invoke('backup:createNow'),
